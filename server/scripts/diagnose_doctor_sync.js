...
async function main() {
    ...
    for (const d of allDoctors) {
        ...
        console.log(`  Doctor tabla: "${d.name}"  |  Usuario: "${userName}"${nameDiff}  |  Activo:${isActive}  |  Citas:${d._count.appointments}  |  Horarios:${d._count.schedules}`);
    }
